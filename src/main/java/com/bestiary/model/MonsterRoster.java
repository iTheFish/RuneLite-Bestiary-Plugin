...
public class MonsterRoster {
    ...
    static {
        ...
        b.put("Aberrant spectre", new int[]{1, 1, 27, 50, 1, 35});
        ...
        b.put("Commander Zilyana", new int[]{80, 70, 70, 60, 10, 78});
        ...
        b.put("Akkha", new int[]{70, 70, 45, 70, 70, 33});
        ...
        b.put("Crystalline Hunllef", new int[]{40, 45, 65, 70, 70, 35});
        b.put("Corrupted Hunllef",   new int[]{45, 50, 75, 80, 80, 40});
    ...
    static {
        ...
        p.put("Red dragon", 2);
        p.put("Black dragon", 25);
        p.put("Lava dragon", 2);
        p.put("Bronze dragon", 25);
        p.put("Iron dragon", 3);
        p.put("Steel dragon", 25);
        p.put("Mithril dragon", 10);
        p.put("Adamant dragon", 25);
        p.put("Rune dragon", 20);
        p.put("Brutal black dragon", 25);
        p.put("Brutal red dragon", 25);
        p.put("Brutal blue dragon", 25);
        p.put("Brutal green dragon", 25);
        p.put("Scurrius", 20);
        p.put("Giant Mole", 30);
        p.put("King Black Dragon", 40);
        p.put("Chaos Elemental", 33);
        ...
        p.put("The Leviathan", 40);
        p.put("Vardorvis", 70);
        p.put("The Whisperer", 40);
        p.put("Nex", 92);
        p.put("TzTok-Jad", 70);
        p.put("TzKal-Zuk", 80);
        ...
        p.put("Kephri", 65);
        p.put("Zebak", 66);
        p.put("Tumeken's Warden", 90);
        p.put("Elidinis' Warden", 90);
        p.put("Abyssal Sire", 40);
        // New monsters (monster-candidates-review.csv, 2026-07-31)
        p.put("Yama", 77);
        p.put("Brutus", 5);
        p.put("Vasa Nistirio", 50);
        p.put("Tormented Demon", 90);
        p.put("Kalphite Queen", 75);
        p.put("Skotizo", 32);
        p.put("Crystalline Hunllef", 78);
        p.put("Corrupted Hunllef", 88);
        p.put("Ice demon", 10);
        p.put("Revenant maledictus", 55);
        p.put("Blood Moon", 55);
        p.put("Blue Moon", 45);
        p.put("Eclipse Moon", 50);
        // Prayer review 2026-08-03 (previously defaulted to 1)
        p.put("Alchemical Hydra", 5);
        p.put("Amoxliatl", 5);
        p.put("Araxxor", 25);
