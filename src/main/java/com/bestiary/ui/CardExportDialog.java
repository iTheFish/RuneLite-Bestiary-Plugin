...
public final class CardExportDialog {
    ...
    public static void copyNow(Window owner, CapturedCreature capture) {
        ...
        drawBanner(g2, 0, AlbumCard.CARD_H, AlbumCard.CARD_W, bottomH, cardId, ownerStr, capture.rerollCount(), capture.generated);
        g2.dispose();
        card.removeNotify();
    ...
    /** Draws the banner: UniqueID + Captured by (+ optional Generated / Rerolled tag) centred, brand pinned bottom. */
    static void drawBanner(Graphics2D g2, int bX, int bY, int bannerW, int bannerH,
                           String cardId, String ownerStr, int rerollCount, boolean generated) {
        ...
        // UniqueID + Captured by (+ optional Generated / Rerolled tag) centred above the brand line
        boolean rerolled = rerollCount > 0;
        String reStr;
        Color tagColor;
        if (generated && rerolled) {
            reStr = "Generated · Rerolled " + rerollCount + (rerollCount == 1 ? " time" : " times");
            tagColor = new Color(90, 190, 180);
        } else if (generated) {
            reStr = "Generated";
            tagColor = new Color(90, 190, 180);
        } else if (rerolled) {
            reStr = "Rerolled " + rerollCount + (rerollCount == 1 ? " time" : " times");
            tagColor = new Color(150, 120, 200);
        } else {
            reStr = null;
            tagColor = null;
        }
