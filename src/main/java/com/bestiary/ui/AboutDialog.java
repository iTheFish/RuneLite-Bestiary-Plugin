...
public class AboutDialog extends JDialog {
    ...
    private static final Release[] RELEASES = {
        new Release("v1.1.0", "Shop, alerts & more monsters", new String[][]{
            ...
            {"Endgame shop (coming soon)", "A new Level 99 shop is on the way for powerful one-use "
                + "consumables — tell us what you'd like to see in the Discord."},
            {"More achievements", "Added discard, reroll, per-rarity album and Power Level milestones, "
                + "plus big kill, capture and XP goals — and the tab now shows how many you've unlocked."},
            {"New monsters", "Baby red & black dragons, three Naguas, a Cockatrice, the Venator, a Frost "
                + "dragon, a Cyclops, and the Chambers of Xeric monsters: Skeletal Mystic, Deathly ranger "
                + "& mage, Vanguard and the Guardian."},
