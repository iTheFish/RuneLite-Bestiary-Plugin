...
public class ProgressionServiceTest {
    ...
    public void firstCatchUnlocksOnFirstCapture() {
        ...
        List<Achievement> newAchievements = service.recordCapture(c);
